...
la première partie du script permet d'importer les packages, les library et les données d'études. La seconde partie explore les possibilité que peut apporter l'ensemble des données de l'IFN à l'étude des peuplements.
...
code_ecologie <- units_value_set %>%
  filter(units %in% c("TOPO", "OBSTOPO", "HUMUS", "OLT", "TSOL", "TEXT1", 
                      "ROCHED0", "OBSRIV2", "DISTRIV", "DENIVRIV", 
                      "OBSVEGET", "OBSDATE"))
